import { dashToCamel, dashToUnderscore, isArray, isObject } from '@ehubbell/utils';
...
// normalize
export const normalizeArray = (type = 'camel', data = [], included = [], meta = {}): { data: any[]; meta: any } => {
...
export const normalize = (type = 'camel', data, attrs = []): { data: any } => {
